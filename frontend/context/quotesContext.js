...
// const value = {
//     genre: ['Murder Mystery', 'Fantasy', 'Non-Fiction']
// }; from task 2

export const QuotesContext = createContext();

// take out from App component
...
// not const QuotesProvider = ({chilcren}) => ()
export function QuotesProvider(props) {
  ...
  const value = {
    ...
    quotes: state.quotes, // or for state just ...state
    createQuote,
    deleteQuote,
    editQuoteAuthenticity,
    setHighlightedQuote,
    toggleVisibility
  } // takes in slices of state and state changers
